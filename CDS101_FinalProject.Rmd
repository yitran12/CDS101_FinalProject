...
#Function Preparation(Hyunwoo Kang)
```{r}
...
```{r}
 Econ_ft %>%
  ...
  labs(title = "Scatterplot of Inflation rate by Year", 
       y = "Inflation Rate", 
       x = "Year")
```
...
Soci_ft %>%
  ...
  labs(title = "Scatterplot of Female Job Occupation rate by Year", y  = "Female Job Occupation", x = "Year")
```
